...
#             'Description': ' '.join(response.xpath('//div[@class="product-information-card_infoText__tuXRX"]//span/text() | //div[@class="product-information-card_infoText__tuXRX"]//strong/text()').getall()),
#             'Image name': [url for url in response.css('div.grid_productDetailGallery__AvuaZ  img::attr(src)').getall() if url.startswith('http') and '520' in url]
#
#         }
#         yield item